...
class _AddTransactionScreenState extends State<AddTransactionScreen> {
  ...
  final categories = ['Food','Bills','Shopping','Travel','Rent','Entertainment','Others'];
  ...
  Future<void> save() async {
    ...
    await DatabaseHelper.instance.insert(CashTransaction(
      type: type, amount: value, category: category,
      note: note.text.trim(), date: DateTime.now(),
    ));
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          FilledButton.icon(onPressed: save, icon: const Icon(Icons.save), label: const Text('Save Transaction')),
        ],
      ),
    );
  }
